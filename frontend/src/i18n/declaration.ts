...
export enum I18nKey {
  ...
  CHAT$SEARCH_PLACEHOLDER = "CHAT$SEARCH_PLACEHOLDER",
  CHAT$NO_RESULTS = "CHAT$NO_RESULTS",
  CHAT$PREVIOUS_RESULT = "CHAT$PREVIOUS_RESULT",
  CHAT$NEXT_RESULT = "CHAT$NEXT_RESULT",
}
