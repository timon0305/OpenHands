...
export enum I18nKey {
  ...
  CONVERSATION$UNARCHIVE = "CONVERSATION$UNARCHIVE",
  CONVERSATION$ARCHIVED_CONVERSATIONS = "CONVERSATION$ARCHIVED_CONVERSATIONS",
  CONVERSATION$CONVERSATION_ARCHIVED = "CONVERSATION$CONVERSATION_ARCHIVED",
  CONVERSATION$CONVERSATION_UNARCHIVED = "CONVERSATION$CONVERSATION_UNARCHIVED",
}
