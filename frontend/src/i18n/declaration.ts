...
export enum I18nKey {
  ...
  SLASH_COMMANDS$TITLE = "SLASH_COMMANDS$TITLE",
  SLASH_COMMANDS$NAVIGATE = "SLASH_COMMANDS$NAVIGATE",
  SLASH_COMMANDS$SELECT = "SLASH_COMMANDS$SELECT",
  SLASH_COMMANDS$CLOSE = "SLASH_COMMANDS$CLOSE",
  SLASH_COMMANDS$KEY_ENTER = "SLASH_COMMANDS$KEY_ENTER",
  SLASH_COMMANDS$KEY_ESCAPE = "SLASH_COMMANDS$KEY_ESCAPE",
}
